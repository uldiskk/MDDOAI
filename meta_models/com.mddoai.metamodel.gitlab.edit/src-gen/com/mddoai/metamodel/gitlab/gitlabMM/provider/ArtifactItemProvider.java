...
/**
 * This is the item provider adapter for a {@link com.mddoai.metamodel.gitlab.gitlabMM.Artifact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_when_feature",
								"_UI_Artifact_type"),
						GitlabMMPackage.Literals.ARTIFACT__WHEN, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GitlabMMPackage.Literals.ARTIFACT__REPORTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(GitlabMMPackage.Literals.ARTIFACT__REPORTS,
				GitlabMMFactory.eINSTANCE.createReport()));
	}
