...
/**
 * This is the item provider adapter for a {@link com.mddoai.metamodel.pim.pimMM.Stage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StageItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						PimMMPackage.Literals.STAGE__NAME, true, false, false,
	...
	protected void addToolPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Stage_tool_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Stage_tool_feature", "_UI_Stage_type"),
						PimMMPackage.Literals.STAGE__TOOL, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PimMMPackage.Literals.STAGE__SCRIPT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case PimMMPackage.STAGE__NAME:
		case PimMMPackage.STAGE__TOOL:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case PimMMPackage.STAGE__SCRIPT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(PimMMPackage.Literals.STAGE__SCRIPT, PimMMFactory.eINSTANCE.createScript()));
	}
