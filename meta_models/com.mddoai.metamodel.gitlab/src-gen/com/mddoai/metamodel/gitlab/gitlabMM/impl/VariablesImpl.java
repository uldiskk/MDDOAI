 ...
 * </p>
 * <ul>
 *   <li>{@link com.mddoai.metamodel.gitlab.gitlabMM.impl.VariablesImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariablesImpl extends MinimalEObjectImpl.Container implements Variables {
	...
	protected EClass eStaticClass() {
		return GitlabMMPackage.Literals.VARIABLES;
	}
	...
	public EList<Variable> getVariables() {
		if (variables == null) {
			variables = new EObjectContainmentEList<Variable>(Variable.class, this,
					GitlabMMPackage.VARIABLES__VARIABLES);
		}
		return variables;
	}
